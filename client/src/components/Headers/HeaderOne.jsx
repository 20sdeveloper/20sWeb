          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                ...
                <div className="menu-wrap mt-2px ml-2px">
                  ...
                  <nav className="menu-box">
                    ...
                    <div className="social-links">
                      <ul className="clearfix list-wrap">
                        <li>
                          <a href=" https://www.facebook.com/share/p/19DVB5L1YW/">
                            <i className="fab fa-facebook-f"></i>
                          </a>
                        </li>
                        <li>
                          <a href=" https://x.com/20sDevelopers/status/1932045972994965513 ">
                          <i className="fab fa-x-twitter"></i>
                          </a>
                        </li>
                        <li>
                          <a href=" https://www.instagram.com/p/DKrYi1_In2G/?utm_source=ig_web_copy_link&igsh=MXc1NWlpMXp4Mjlpcw==">
                            <i className="fab fa-instagram"></i>
                          </a>
                        </li>
                        <li>
                          <a href="https://www.linkedin.com/posts/20s-developers_digitaltransformation-techforgrowth-customhimssolutions-activity-7337798693443592192-dnjJ?utm_source=share&utm_medium=member_android&rcm=ACoAAD6pd48BNTBU1fF8NvWidi1UmHuJ54rWAP8 ">
